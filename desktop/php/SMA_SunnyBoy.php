...
<script>
	function ShowHide() {
  		...
  		var divPower = document.getElementById("divPower");
  		divPower.style.display = DeviceType.value >= 30 ? "none" : "block";
  	}
</script>
					...
					<fieldset>
						<div class="col-lg-6">
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									...
									<select class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="DeviceType" id="DeviceType" onchange = "ShowHide()">
										<option value="10">Onduleur Monophasé - Sunny Boy</option>
                                    	<option value="20">Onduleur Triphasé - Sunny Tripower</option>
                                        <option value="30">Compteur Energie Monophasé - SMA Energy Meter</option>
                                        <option value="40">Compteur Energie Triphasé - SMA Energy Meter</option>
									</select>
								</div>
							</div>  
							...
							<div class="form-group" id="divPort" style="display: block">
                          	...
                          	<div class="form-group" id="divProtocol" style="display: block">
								<label class="col-sm-3 control-label">{{Protocole}}</label>
								<div class="col-sm-3">
									<!-- <input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="Protocol" placeholder="Protocole"/> -->
									<select class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="Protocol" id="Protocol">
										<option value="10" selected>HTTPS</option>
							...
							<div class="form-group" id="divPower" style="display: none">
